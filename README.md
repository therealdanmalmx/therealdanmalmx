...
![Skills](https://skillicons.dev/icons?i=cs,git,js,ts,vscode,html,react,nextjs,vue,nuxtjs,css,sass,tailwind,vite,nodejs,express,graphql,mongodb,postgres,figma,apple,dotnet,aws,docker)
